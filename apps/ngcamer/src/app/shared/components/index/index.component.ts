...
export class IndexComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if(this.indexArticles){
      ...
      this.metaService.updateTag({ name: 'og:title', content: `Cameroun,Cameroon Camer.be, l'information claire et nette::Cameroun,Cameroon,CAMEROUN INFO ,CAMEROUN ACTU` });
      this.metaService.updateTag({ name: 'og:description', content: `Camer.be est le site de la diaspora du cameroun. camer.be is the leading portal of cameroon in belgium. L&#039;info claire et nette.` });
      ...
      this.metaService.updateTag({ name: 'twitter:description', content: `Camer.be est le site de la diaspora du cameroun. camer.be is the leading portal of cameroon in belgium. L&#039;info claire et nette.` });
      ...
      this.metaService.updateTag({ name: 'twitter:image:alt', content:  `Cameroun,Cameroon Camer.be, l'information claire et nette::Cameroun,Cameroon,CAMEROUN INFO ,CAMEROUN ACTU` });
